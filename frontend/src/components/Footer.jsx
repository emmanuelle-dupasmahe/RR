        ...
        <footer className="bg-black border-t-2 border-[#222] px-[40px] py-[20px] text-center text-[#888888] text-[0.875rem]">
            <div className="max-w-[80rem] mx-auto flex flex-col items-center gap-[16px]">
                ...
                <div className="flex gap-[24px] justify-center">
                    ...
                    <a href="https://youtu.be/3cRyjkJLPco?si=JFDvq7Xpb0OxsTF-" target="_blank" rel="noopener noreferrer" title="YouTube" className="group inline-flex items-center justify-center w-[40px] h-[40px] no-underline transition-transform duration-300 hover:scale-110">
                        <svg viewBox="0 0 24 24" className="w-[24px] h-[24px]">
