        ...
        <footer className="bg-white dark:bg-black px-[40px] py-[30px] text-center transition-colors duration-300 font-sans">
            <div className="max-w-[80rem] mx-auto flex flex-col items-center gap-[24px]">
                ...
                <div className="flex gap-[24px] justify-center">
                    ...
                    {/* YouTube */}
                    <a href="https://www.youtube.com/@marsu83140" target="_blank" rel="noopener noreferrer" title="YouTube" className="group inline-flex items-center justify-center w-[40px] h-[40px] no-underline transition-transform duration-300 hover:scale-110">
                        <svg viewBox="0 0 24 24" className="w-[24px] h-[24px]">
                            <path
                                fill="currentColor"
                                className="text-gray-400 dark:text-[#888888] group-hover:text-primary transition-colors duration-300"
