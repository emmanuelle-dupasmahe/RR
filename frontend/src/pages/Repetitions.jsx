...
function Repetitions() {
    ...
    return (
        ...
        <>
            <Helmet>
                <title>Reservoir Rock | Répétitions</title>
                <meta
                    name="description"
                    content="Reservoir Rock, page sur les répétitions."
                />
                <link rel="canonical" href="https://resrock.fr/repetition" />
            </Helmet>
            ...
            <div className="mt-[80px] min-h-[calc(100vh-82px)] bg-white dark:bg-black transition-colors duration-300">
                ...
                <div className="max-w-[56rem] mx-auto px-[20px] py-[40px] flex flex-col gap-[16px]">
                    ...
                    /* --- HALO ROUGE (Mode Clair + Sombre) --- */
                    before:content-[''] before:absolute before:top-[-50%] before:left-[-20%] before:w-[80%] before:h-[200%]
                    before:bg-[radial-gradient(circle_at_center,rgba(227,24,31,0.12)_0%,rgba(255,255,255,0)_60%)] before:pointer-events-none
                    dark:before:bg-[radial-gradient(circle_at_center,rgba(227,24,31,0.15)_0%,rgba(0,0,0,0)_60%)]
                    ...
                    dark:bg-[#111] dark:border-white/5 dark:hover:border-primary/30"
                            >
                                ...
                                <div className="relative z-10 flex items-center gap-[16px] flex-1 w-full">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            {m.end_time && (
                                                <span className="text-[8px] md:text-[10px] bg-primary/20 text-primary px-2 py-0.5 rounded font-bold uppercase tracking-tighter whitespace-nowrap">
                                                    <span className="hidden md:inline">Segment: {m.start_time || 0}s - {m.end_time}s</span>
                                                    <span className="md:hidden">{m.start_time || 0}s-{m.end_time}s</span>
                                                </span>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="relative z-10 w-full md:max-w-[350px] p-[3px] rounded-full overflow-hidden shadow-lg
