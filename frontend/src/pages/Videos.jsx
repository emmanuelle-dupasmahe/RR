...
function Videos() {
    ...
    return (
        <>
            <Helmet>
                <title>Reservoir Rock | Vidéos</title>
                <meta
                    name="description"
                    content="Reservoir Rock, page sur les vidéos."
                />
                <link rel="canonical" href="https://resrock.fr/videos" />
            </Helmet>
                            ...
                            {totalPages > 1 && (
                                <div className="mt-20 flex justify-center items-center gap-2 md:gap-6">
                                    <button
                                        ...
                                        className="px-3 md:px-8 py-2 md:py-3 bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/10 text-black dark:text-white hover:border-primary dark:hover:border-primary disabled:opacity-20 transition-all uppercase font-black text-[10px] md:text-xs tracking-widest cursor-pointer shadow-lg"
                                    >
